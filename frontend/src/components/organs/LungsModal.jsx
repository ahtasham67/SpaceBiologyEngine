export default function LungsModal({ onClose }) {
  return (
    <div className="bg-gradient-to-br from-slate-800 to-slate-900 text-white p-8 rounded-2xl w-96 max-w-md mx-4 shadow-2xl border border-slate-600">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-2xl font-bold text-cyan-400">Lungs</h2>
      ...
      <div className="bg-cyan-900/20 p-3 rounded-lg mb-4">
        <p className="text-gray-100 text-sm leading-relaxed">
          Reduced lung capacity and altered breathing patterns due to fluid redistribution.
        </p>
      </div>
      ...
      <div className="flex gap-3">
        ...
        <button
          ...
          onClick={() => console.log('Research more about Lungs')}
        >
          Research More
        </button>
      </div>
